...
const Home = () => {
	...
	return (
		<div className='flex h-screen sm:h-[450px] md:h-[550px] w-full sm:rounded-lg overflow-hidden bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
